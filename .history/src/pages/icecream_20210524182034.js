...
const Creem = (props) => {
  ...
  useEffect(() => {
    ...
    // console.log(props.selectRating(4))
    ...
    return (
      <div  key={index}>
        ...
        <div id='ic-stars-container'>
          <div id='ic-stars'>
            <img onClick={props.selectRating(1)} src='https://res.cloudinary.com/dhad6e9gj/image/upload/v1621617727/Frozzy%20Project/Star_Icon-01-01_mzyxnw.png'/>
            <img onClick={props.selectRating(2)} src='https://res.cloudinary.com/dhad6e9gj/image/upload/v1621617727/Frozzy%20Project/Star_Icon-01-01_mzyxnw.png'/>
            <img onClick={props.selectRating(3)}  src='https://res.cloudinary.com/dhad6e9gj/image/upload/v1621617727/Frozzy%20Project/Star_Icon-01-01_mzyxnw.png'/>
            <img onClick={props.selectRating(4)} src='https://res.cloudinary.com/dhad6e9gj/image/upload/v1621617727/Frozzy%20Project/Star_Icon-01-01_mzyxnw.png'/>
            <img onClick={props.selectRating(5)} src='https://res.cloudinary.com/dhad6e9gj/image/upload/v1621617727/Frozzy%20Project/Star_Icon-01-01_mzyxnw.png'/>
            <div>
