    ...
    return (
      <div  key={index}>
        ...
        <div id='ic-stars-container'>
          <div id='ic-stars'>
            <img onClick={() => props.selectRating(creem._id, 1)} src='https://res.cloudinary.com/dhad6e9gj/image/upload/v1621617727/Frozzy%20Project/Star_Icon-01-01_mzyxnw.png'/>
